...
\[capability\] that make Hajj #strong[Farz (فرض)] \[obligatory\]. Class
3 covered #strong[Zad (زاد)] \[travel provisions\] and #strong[Rahila
(راحلة)] \[means of transport\]. Today's focus:

+ #strong[Amn al-Tariq (أمن الطريق)] --- safety and security of the
  journey.
+ #strong[Conditions specific to women] --- especially #strong[mahram
...
=== Central question
<central-question>
If a person has money and transport but #strong[travel is not safe] for
any reason, is Hajj still obligatory?
...
- #strong[Practical result:] If he never got safety in his life and is
  now dying, #strong[Hajj-e-Badal (حج البدل)] \[proxy Hajj\] and
  #strong[wasiyyah (وصية)] \[bequest\] may be required --- because Hajj
  was already obligatory on him, only performance was delayed.
...
#strong[Their argument:] Since the hadith does not mention #strong[amn
(أمن)] \[safety\], safety is #strong[not] a condition for obligation ---
only for going.

#horizontalrule

=== Opinion 2 --- Preferred (Hanafi): safety is a condition for #emph[obligation] itself
<opinion-2-preferred-hanafi-safety-is-a-condition-for-obligation-itself>
- #strong[Without safety, Hajj is not Farz at all] --- not merely
  delayed.
- If he dies without ever having safe travel, #strong[Hajj-e-Badal is
  not Wajib (واجب)] \[obligatory\] on him before death, because Hajj was
  never established as Farz on him.

#strong[Quranic basis]
...
Similarly, the same hadith does #strong[not] mention #strong[physical
fitness (quwwah badaniyyah)] --- yet everyone agrees a paralysed person
without help is not obligated. The hadith describes what is
...
#figure(
  align(center)[#table(
    ...
    [Listed in the hadith?], [Yes (as example)], [Yes (as example)], [No
    --- but same rule],
    [Role in obligation], [Part of Istita'at], [Part of
    Istita'at], [Part of Istita'at],
  )]
  , kind: table
  )
...
<part-2-conditions-specific-to-women>
Two extra conditions (Hanafi study); the second will be completed next
class:
...
#strong[Evidence --- Hadith specific to Hajj]
...
miles (77 km)] --- #strong[Safar (سفر)] \[long journey\] in Sharia
terms. Hajj from outside Makkah is always this type of travel.

#strong[Two reasons for mahram (as taught)]

+ #strong[Protection (hifz / amn)] --- from non-mahram men on a long
  journey; women need a protector.
+ #strong[Physical support] --- travel is hard; a mahram helps her
  during the journey.
...
- Other women are also #strong[not safe alone] on long travel in the
  same way.
- A larger group of women does #strong[not] remove the need for mahram
  --- harm and #strong[fitnah (فتنة)] \[temptation / moral risk\] can
  increase, not decrease.
- #strong[Khalwah (خلوة)] \[seclusion\] with a non-mahram man is haram
  #strong[even if other women are present] --- so protection by women
...
<part-2b-mahram-must-be-ready-and-financially-covered>
Hajj is Farz on the woman only when #strong[all] of the following are
already in place:

+ #strong[Mahram (or husband) exists] and is #strong[willing to travel]
  with her.
+ She has enough wealth for #strong[her own] Zad, Rahila, and journey
  costs.
+ She has enough wealth for the #strong[mahram's] journey costs as well
  --- #strong[nafaqa (نفقة)] \[maintenance\] of the mahram for that
  trip.

#strong[Important:] It is #strong[her duty] to afford the mahram's
expenses for Hajj --- #strong[not] the mahram's duty to pay for himself
so she can go. If she cannot afford both, Hajj is #strong[not Farz] on
her.
...
#strong[She does not have to:]

- #strong[Force] the mahram to travel.
- #strong[Borrow money] or put herself in hardship to arrange the
  mahram's costs --- if money is not there easily, Hajj is not Farz.
- #strong[Get married] just to obtain a mahram for Hajj.

#strong[Analogy --- poor man:] A poor man is not told to borrow and
...
#strong[Optional:] Some women collect money over years for Hajj by
choice --- that is #strong[Nafl / optional] effort, not a Sharia
command.

#horizontalrule

=== Two opinions --- must she arrange mahram's costs if she is rich enough?
<two-opinions-must-she-arrange-mahrams-costs-if-she-is-rich-enough>
#figure(
  align(center)[#table(
    columns: (52.94%, 47.06%),
    align: (auto,auto,),
...
#strong[Preferred view reasoning:] Same as above --- Sharia does not
command #strong[takalluf (تكلف)] \[unnecessary burden\] to manufacture a
condition.

#horizontalrule

== Part 2C --- Husband's Permission
<part-2c-husbands-permission>
#figure(
  align(center)[#table(
    columns: (31.11%, 68.89%),
    align: (auto,auto,),
    table.header([Journey type], [Husband's permission (Hanafi)],),
    table.hline(),
...
#strong[Hanafi proof by analogy:] She does not need husband's permission
...
#strong[Example:] Brother is mahram, ready to go, she has money for both
--- Hajj is Farz; she may go #strong[even if husband refuses] (Hanafi).

#horizontalrule

== Part 2D --- What Counts as Mahram?
<part-2d-what-counts-as-mahram>
#strong[Mahram] = a man with whom #strong[marriage is permanently
impossible (haram forever)] --- by blood, nursing, or permanent marriage
relationship (e.g.~father, son, brother, father-in-law, son-in-law).

#strong[Not sufficient:]

- #strong[Temporary mahram] --- e.g.~a relationship that only blocks
  marriage for a limited time; not valid for this travel rule.
- #strong[Immature boy] --- mahram by relation but too young to protect
  anyone.
- #strong[Majnun (مجنون)] \[insane person\] --- cannot handle a hard
  journey.
- #strong[Majusi (مجوسي)] \[fire-worshipper\] non-Muslim mahram --- in
  their religion incest may be permitted; not a safe companion in
  Sharia's view.
- #strong[Kafir (كافر)] non-Muslim mahram who is #strong[not] majusi ---
  #strong[some allowance] in discussion (e.g.~Christian brother may
  travel if he protects honour); #strong[except] the majusi case as
  taught.
...
He must perform Hajj when capability returns --- #strong[Hajj-e-Badal]
rules apply if he dies while still owing it (if Hajj had truly become
Farz earlier).
...
- #strong[Hanafi and Shafi‘i] both have strict rules; Shafi‘i allows
  ...
  requirement.
- Sensitivity of #strong[women's safety] in Sharia is #strong[severe
  (shadid)] --- do not treat it lightly because of modern custom.

#strong[Practical note for students:] Teach with wisdom and clarity;
rulings are from Sharia, not from visa policy.
...
- Monday & Wednesday → #strong[9:30 PM]
- Tuesday, Thursday & Friday → #strong[7:15 PM]
