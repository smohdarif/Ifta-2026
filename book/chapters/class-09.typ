...
<introduction-topics-in-this-series-overview>
This lesson begins a structured study of #strong[Tawaf al-Ziyarah (طواف
الزيارة)] \[the farewell/obligatory tawaf of Hajj\]. The teacher
outlined the sequence of topics to be covered:

+ #strong[Dalīl (دليل)] \[evidence\] behind the #strong[wujūb (وجوب)]
  \[obligation\] of Tawaf al-Ziyarah.
+ #strong[Rukn (ركن)] \[essential pillar\] of Tawaf al-Ziyarah ---
  without it, the tawaf is not valid.
+ #strong[Shurūt (شروط)] \[conditions\], #strong[wājibāt (واجبات)]
  \[necessary acts\], and #strong[sunan] of Tawaf al-Ziyarah (including
  #strong[ṭahārah (طهارة)] \[ritual purity\] --- detailed next class).
+ #strong[Wuqūf (وقوف)] at the #strong[Maqām (مقام)] \[station\] of
  Ibrāhīm during tawaf --- method and ruling.
+ #strong[Raml (رمل)] in the first three circuits --- method and ruling.
+ #strong[Fixed days] for this tawaf --- what if someone cannot perform
  it within those days?

#strong[Today's class:] points 1--2 in detail, and #strong[niyyah] as a
condition (part of point 3). #strong[Ṭahārah] and #strong[timing of
Tawaf al-Ziyarah] --- next class inshā'Allāh.
...
Among all types, #strong[only the tawaf performed in the days of Eid]
(Tawaf al-Ziyarah / Ifāḍah) is #strong[compulsory on everyone]
performing Hajj --- whether from Makkah, Ḥill, or abroad.
...
<evidence-1-quran-command-to-perform-tawaf>
#quote(block: true)[
...
<evidence-2-quran-obligation-of-hajj-of-the-house>
#quote(block: true)[
...
#strong[Linguistic dalīl:] The word #strong[ḥajj (حج)] comes from
#strong[qaṣd (قصد)] --- to intend / set out for something. Here it means
to intend the #strong[visit (ziyārah)] of #strong[Baytullāh] for the
sake of Allah --- which, in Sharīʿah, is fulfilled by #strong[ṭawāf]
...
#figure(
  align(center)[#table(
    ...
    to], [#strong[Rukn yes] --- but #strong[missed wājib] → #strong[dam
    (دم)] \[penalty sacrifice\]],
    [Riding / carried in crowd without feet on ground, though
    able], [#strong[Rukn yes] --- #strong[dam] for missing wājib of
    walking],
  )]
  , kind: table
  )
...
<far-vs-wajib-critical-distinction>
#figure(
  align(center)[#table(
...
<carrier-and-carried-both-complete-rukn>
#strong[Yes (Hanafi teaching in class).] Both the #strong[ḥāmil (حامل)]
\[carrier\] and #strong[maḥmūl (محمول)] \[carried\] complete the
...
#figure(
  align(center)[#table(
    ...
    (absolute niyyah)],
    [Without senses / niyyah], [Can still count], [#strong[Does not]
    count],
  )]
  , kind: table
  )
...
#strong[any of the Eid days] (10th, 11th, 12th --- and details of
#strong[13th] and exact windows come in the #strong[timing] lesson). You
do #strong[not] have to wait until the 13th. #strong[Exact time periods]
--- next class.
...
- #strong[Next class:] #strong[Ṭahārah] for ṭawāf, and #strong[fixed
  times] for Tawaf al-Ziyarah --- same time inshā'Allāh.
